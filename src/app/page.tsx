        ...
        <div className="bg-[#cfe6ff]">
            <div className="text-[#150e60] min-h-screen content-center pt-28 px-8 md:px-16 lg:px-28">
                <div className="flex flex-col mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 content-center gap-8 mb-8">
                        ...
                        <div className="lg:col-span-2 content-center">
                            <div className="text-center lg:text-left">
                                ...
                                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-4">บริษัท/ห้างหุ้นส่วน</h2>
                                <br />
                                <p className="text-lg md:text-xl lg:text-3xl leading-relaxed">
                    ...
                    {/* ส่วนล่าง */}
                    <div className="flex flex-col lg:flex-row items-center lg:space-x-28 mt-12 space-y-8 lg:space-y-0">
                        <p className="text-xl md:text-2xl lg:text-3xl text-gray-400 font-bold text-center lg:text-left">
                            หากต้องการทราบรายละเอียดบริการทั้งหมด กรุณาคลิกที่นี่
                        </p>
                        <a href="/" className="flex text-lg md:text-2xl lg:text-3xl text-[#150e60] bg-[#6e9cfe] rounded-full border-4 border-[#322379] justify-center items-center p-1">
                        ...
                        <div className="flex space-x-8 lg:space-x-16 justify-center">
                            <a href="/about"><img src="/images/home/Phone.png" alt="" className="h-12 md:h-16 lg:h-20" /></a>
                            <a href="/about"><img src="/images/home/Line.png" alt="" className="h-12 md:h-16 lg:h-20" /></a>
                            <a href="/about"><img src="/images/home/Facebook.png" alt="" className="h-12 md:h-16 lg:h-20" /></a>
                        </div>
                    </div>
                </div>
            </div>
